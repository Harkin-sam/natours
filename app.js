...
// because we need the body in a raw form using express.raw for the function thats why we use app.post and not mounted in booking route i.e we need it as a stream not as json so that why it is placed before the BODY PARSER MIDDLEWARE below
